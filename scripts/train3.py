...
from minimal_impl.cartesian import (
    generate_bloch_data,
    generate_mm3_bloch_product_data,
    generate_mm3_bloch_product_data_sampled,
    generate_mm3_data,
)
import json
import yaml
...
def main():
    ...
    if process_mode == 'mm3_bloch_product':
        # Use sampled version for memory efficiency with large context lengths
        dataloader, loss_lower_bound, d_vocab = generate_mm3_bloch_product_data_sampled(
            process_cfg.get('mm3', {}),
            process_cfg.get('bloch', {}),
